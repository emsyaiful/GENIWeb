	...
	<div class="container" ng-controller="">
		<div class="card card-container">
            ...
            <form class="form-signin" name="form">
                ...
                <textarea ng-model="" placeholder="Your Description" id="inputDesc" name="input_desc" class="form-control" required style="height:44px"></textarea><br>
                <input ng-model="" type="file" name="input_payslip" id="inputPayslip" class="form-control" required><br>
