        ...
        <div class="col-sm-8">
          <div class="about-info wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
            ...
            <h2>Pertanyaan Umum</h2>
              <ul class="list-group">
              	<li class="list-group-item list-group-item-action list-group-item-info"><a href="#" class="listtanya" data-id="1" style="color:#001a4d"><b>Apa perbedaan Gen1 dengan trial dan berbayar?</b></a></li>
              	...
              	<li class="list-group-item list-group-item-action list-group-item-info"><a href="#" class="listtanya" data-id="2" style="color:#001a4d"><b>Apakah Gen1 hanya bisa di akses pada PC saja?</b></a></li>
              	...
              	<li class="list-group-item list-group-item-action list-group-item-info"><a href="#" class="listtanya" data-id="3" style="color:#001a4d"><b>Minimal spesifikasi apa yang dapat mengakses Gen1?</b></a></li>
            ...
            <div id="tag2" hidden>
              ...
              <ul class="list-group">
              	<li class="list-group-item list-group-item-action list-group-item-info"><a href="#" class="listtanya" data-id="4" style="color:#001a4d"><b>Apa yang terjadi bila masa trial habis?</b></a></li>
              	...
              	<li class="list-group-item list-group-item-action list-group-item-info"><a href="#" class="listtanya" data-id="5" style="color:#001a4d"><b>Apa yang terjadi bila masa aktif habis?</b></a></li>
            ...
            <div id="tag3" hidden>
              <h2>Modul</h2>
              <ul class="list-group">
              	<li class="list-group-item list-group-item-action list-group-item-info"><a href="#" class="listtanya" data-id="7" style="color:#001a4d"><b>Apakah terdapat module lain selain Finance &amp; Accounting pada Gen1?</b></a></li>
              	...
              	<li class="list-group-item list-group-item-action list-group-item-info"><a href="#" class="listtanya" data-id="8" style="color:#001a4d"><b>Pada modul Finance &amp; Accounting Gen1 report apa saja yang dapat dihasilkan?</b></a></li>
              	...
              	<li class="list-group-item list-group-item-action list-group-item-info"><a href="#" class="listtanya" data-id="9" style="color:#001a4d"><b>Apa yang harus dipersiapkan untuk memulai awal system Gen1 modul Finance &amp; Accounting?</b></a></li>
            ...
            <div id="tag4" hidden>
              <h2>Pembayaran</h2>
              <ul class="list-group">
              	<li class="list-group-item list-group-item-action list-group-item-info"><a href="#" class="listtanya" data-id="10" style="color:#001a4d"><b>Bagaimana cara melakukan pembayarannya?</b></a></li>
              	...
              	<li class="list-group-item list-group-item-action list-group-item-info"><a href="#" class="listtanya" data-id="11" style="color:#001a4d"><b>Apabila telah melakukan pembayaran, apakah masa aktif pada akun saya jadi bertambah?</b></a></li>
